...
import com.assignment.suitmedia.database.RemoteKeys
...
class UserRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiService.getUsers(page, perPage = state.config.pageSize)

            val users = responseData.data
            ...
            database.withTransaction {
                ...
                val keys = users.map { data: DataItem ->
    ...
    private suspend fun getRemoteClosestToCurrentPosition(state: PagingState<Int, DataItem>): RemoteKeys? {
